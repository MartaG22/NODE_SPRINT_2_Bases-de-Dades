...
VALUES
    ...
    (10, 4, NULL, 'Carrer Gran', 4, '2', '2', 'Figueres', 17600, 'Girona'),
    (11, NULL, 7, 'Passeig Central', 65, '3', 'B', 'Portbou', 17497, 'Girona'),
    (12, NULL, 8, 'Carrer del Mar', 15, 'Bx.', '-', 'Colera', 17496, 'Girona');
